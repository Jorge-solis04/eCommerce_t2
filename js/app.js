const productData = [
  {
    ...
    image: 'img1.jpg',
    des: '"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur, eius accusamus. Necessitatibus eum voluptas dolores."'
  },
  {
    index: "02",
...
let backdrpImg = document.querySelector(".backdrop-img");
...
nxtBtn.addEventListener("click", () => {
  ...
  setTimeout(() => {
    ...
    backdrpImg.classList.remove("fade");
